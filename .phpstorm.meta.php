...
'admin.name','admin.logo','admin.default_avatar','admin.directory','admin.bootstrap',
'admin.route.prefix','admin.route.domain','admin.route.namespace','admin.route.middleware','admin.route.without_extra_routes',
'admin.auth.login_captcha','admin.auth.enable','admin.auth.permission','admin.auth.token_expiration','admin.auth.guard',
'admin.auth.guards.admin.driver','admin.auth.guards.admin.provider','admin.auth.providers.admin.driver','admin.auth.providers.admin.model','admin.auth.except',
'admin.upload.disk','admin.upload.directory.image','admin.upload.directory.file','admin.upload.directory.rich','admin.https',
'admin.show_development_tools','admin.show_auto_generate_permission_button','admin.extension.dir','admin.layout.title','admin.layout.header.refresh',
'admin.layout.header.dark','admin.layout.header.full_screen','admin.layout.header.locale_toggle','admin.layout.header.theme_config','admin.layout.locale_options.en',
'admin.layout.locale_options.zh_CN','admin.layout.keep_alive_exclude','admin.layout.footer','admin.database.connection','admin.models.admin_user',
'admin.models.admin_role','admin.models.admin_menu','admin.models.admin_permission','admin.modules_namespace','admin.modules_dir',
'admin.modules','app.name','app.env','app.debug','app.url',
...
'auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.guards.admin.driver','auth.guards.admin.provider','auth.providers.users.driver',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.login_captcha','auth.enable',
'auth.permission','auth.token_expiration','auth.guard','auth.except','cache.default',
...
'filesystems.links./www/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'apis.store','apis.show','apis.edit','apis.update','apis.destroy','settings.index',
'settings.create','settings.store','settings.show','settings.edit','settings.update',
'settings.destroy','storage.local',);
...
'admin.remember_me','admin.login','admin.logout','admin.username','admin.password',
'admin.old_password','admin.confirm_password','admin.captcha','admin.captcha_error','admin.required',
'admin.login_successful','admin.login_failed','admin.user_setting','admin.created_at','admin.updated_at',
'admin.deleted_at','admin.actions','admin.create','admin.edit','admin.show',
'admin.delete','admin.batch_delete','admin.copy','admin.confirm_delete','admin.back',
'admin.reset','admin.search','admin.list','admin.add','admin.save',
'admin.detail','admin.developer','admin.code_generator','admin.visual_editor','admin.terminal',
'admin.administrator','admin.soft_delete','admin.keyword','admin.unknown_error','admin.upload_file_error',
'admin.parent','admin.order','admin.order_desc','admin.order_asc','admin.menus',
'admin.successfully','admin.failed','admin.successfully_message','admin.failed_message','admin.action_success',
'admin.action_failed','admin.save_success','admin.save_failed','admin.yes','admin.no',
'admin.need_start_with_slash','admin.cancel','admin.please_login','admin.unauthorized','admin.user_disabled',
'admin.preview','admin.more','admin.per_page_suffix','admin.code_generators.remark1','admin.code_generators.remark2',
'admin.code_generators.remark3','admin.code_generators.table_name','admin.code_generators.new_table_name','admin.code_generators.model_name','admin.code_generators.controller_name',
'admin.code_generators.service_name','admin.code_generators.primary_key','admin.code_generators.primary_key_description','admin.code_generators.options','admin.code_generators.create_database_migration',
'admin.code_generators.create_table','admin.code_generators.create_model','admin.code_generators.create_controller','admin.code_generators.create_service','admin.code_generators.app_title',
'admin.code_generators.new_app_title','admin.code_generators.column_name','admin.code_generators.type','admin.code_generators.extra_params','admin.code_generators.nullable',
'admin.code_generators.index','admin.code_generators.default_value','admin.code_generators.comment','admin.code_generators.exists_table','admin.code_generators.generate_code',
'admin.code_generators.expand_more_settings','admin.code_generators.collapse_settings','admin.code_generators.confirm_generate_code','admin.code_generators.preview','admin.code_generators.base_info',
'admin.code_generators.column_info','admin.code_generators.route_config','admin.code_generators.page_config','admin.code_generators.gen_route_menu','admin.code_generators.route',
'admin.code_generators.menu_name','admin.code_generators.parent_menu','admin.code_generators.menu_icon','admin.code_generators.name_label_desc','admin.code_generators.column_warning',
'admin.code_generators.add_column','admin.code_generators.scope','admin.code_generators.list_component','admin.code_generators.list_component_desc','admin.code_generators.form_component',
'admin.code_generators.form_component_desc','admin.code_generators.detail_component','admin.code_generators.detail_component_desc','admin.code_generators.model_config','admin.code_generators.file_column',
'admin.code_generators.file_column_multi','admin.code_generators.file_column_desc','admin.code_generators.preview_code','admin.code_generators.property','admin.code_generators.property_name',
'admin.code_generators.value','admin.code_generators.dialog_form','admin.code_generators.copy_record','admin.code_generators.copy_record_description','admin.code_generators.import_record',
'admin.code_generators.import_record_placeholder','admin.code_generators.import_record_desc','admin.code_generators.load_config','admin.code_generators.load_component_config','admin.code_generators.fill',
'admin.code_generators.save_current_config','admin.code_generators.input_config_name','admin.code_generators.same_name_tips','admin.code_generators.save_path_dir','admin.code_generators.save_path_select',
'admin.code_generators.save_path_select_tips','admin.code_generators.save_path_label_prefix','admin.code_generators.clear_code','admin.code_generators.select_clear_record','admin.code_generators.select_generate_record',
'admin.code_generators.duplicate_column','admin.code_generators.common_field_add','admin.code_generators.common_field_add_column','admin.code_generators.config_name','admin.code_generators.field_config',
'admin.code_generators.field_name','admin.code_generators.list_display','admin.code_generators.duplicate_filter_input_name','admin.code_generators.list_filter','admin.code_generators.filter_type',
'admin.code_generators.filter_mode','admin.code_generators.filter_mode_fixed','admin.code_generators.filter_mode_fixed_value','admin.code_generators.filter_mode_input','admin.code_generators.filter_input_name',
'admin.code_generators.filter_input_label','admin.code_generators.filter_component','admin.code_generators.page','admin.code_generators.dialog','admin.code_generators.drawer',
'admin.code_generators.dialog_size','admin.code_generators.drawer_size','admin.code_generators.clone_record','admin.admin_users','admin.admin_user.avatar',
'admin.admin_user.name','admin.admin_user.roles','admin.admin_user.search_username','admin.admin_user.password_confirmation','admin.admin_user.old_password_required',
'admin.admin_user.old_password_error','admin.admin_user.username_already_exists','admin.admin_user.cannot_delete','admin.admin_roles','admin.admin_role.name',
'admin.admin_role.slug','admin.admin_role.permissions','admin.admin_role.slug_description','admin.admin_role.name_already_exists','admin.admin_role.slug_already_exists',
'admin.admin_role.set_permissions','admin.admin_role.cannot_delete','admin.admin_role.used','admin.admin_permissions','admin.admin_permission.name',
'admin.admin_permission.slug','admin.admin_permission.http_method','admin.admin_permission.http_method_description','admin.admin_permission.http_path','admin.admin_permission.auto_generate',
'admin.admin_permission.auto_generate_confirm','admin.admin_permission.parent_id_not_allow','admin.admin_permission.name_already_exists','admin.admin_permission.slug_already_exists','admin.admin_menus',
'admin.admin_menu.parent_id','admin.admin_menu.order','admin.admin_menu.title','admin.admin_menu.icon','admin.admin_menu.icon_description',
'admin.admin_menu.url','admin.admin_menu.iframe_description','admin.admin_menu.visible','admin.admin_menu.type','admin.admin_menu.keep_alive',
'admin.admin_menu.api','admin.admin_menu.api_description','admin.admin_menu.route','admin.admin_menu.link','admin.admin_menu.iframe',
'admin.admin_menu.page','admin.admin_menu.class_name','admin.admin_menu.class_name_description','admin.admin_menu.show','admin.admin_menu.hide',
'admin.admin_menu.is_home','admin.admin_menu.is_home_description','admin.admin_menu.is_full','admin.admin_menu.is_full_description','admin.admin_menu.parent_id_not_allow',
'admin.admin_menu.component','admin.admin_menu.component_desc','admin.admin_menu.url_exists','admin.extensions.name_invalid','admin.extensions.exists',
'admin.extensions.menu','admin.extensions.page_title','admin.extensions.create','admin.extensions.install','admin.extensions.create_extension',
'admin.extensions.create_tips','admin.extensions.local_install','admin.extensions.more_extensions','admin.extensions.setting','admin.extensions.enable',
'admin.extensions.enable_confirm','admin.extensions.disable','admin.extensions.disable_confirm','admin.extensions.uninstall','admin.extensions.uninstall_confirm',
'admin.extensions.filter_placeholder','admin.extensions.form.create_extension','admin.extensions.form.name','admin.extensions.form.namespace','admin.extensions.form.create_description',
'admin.extensions.card.author','admin.extensions.card.version','admin.extensions.card.homepage','admin.extensions.card.status','admin.extensions.status_map.enabled',
'admin.extensions.status_map.disabled','admin.extensions.validation.file','admin.extensions.validation.invalid_package','admin.export.title','admin.export.all',
'admin.export.page','admin.export.selected_rows','admin.export.page_no_data','admin.export.selected_rows_no_data','admin.export.please_install_laravel_excel',
'admin.pages.menu','admin.pages.title','admin.pages.sign','admin.pages.page','admin.pages.schema_cannot_be_empty',
'admin.pages.sign_exists','admin.relationships.menu','admin.relationships.model','admin.relationships.title','admin.relationships.remark',
'admin.relationships.generate_model','admin.relationships.generate','admin.relationships.args','admin.relationships.type','admin.relationships.related_model',
'admin.relationships.through_model','admin.relationships.model_exists','admin.relationships.rel_name_exists','admin.apis.menu','admin.apis.title',
'admin.apis.path','admin.apis.template','admin.apis.enabled','admin.apis.args','admin.apis.path_exists',
'admin.apis.template_format_error','admin.apis.template_exists','admin.apis.add_template','admin.apis.add_template_tips','admin.apis.paste_template',
'admin.apis.overlay','admin.api_templates.data_list','admin.api_templates.data_create','admin.api_templates.data_update','admin.api_templates.data_delete',
'admin.api_templates.data_detail','menu.dashboard','menu.admin_system','menu.admin_users','menu.admin_roles',
'menu.admin_permission','menu.admin_menu','menu.admin_setting','admin::admin.remember_me','admin::admin.login',
'admin::admin.logout','admin::admin.username','admin::admin.password','admin::admin.old_password','admin::admin.confirm_password',
'admin::admin.captcha','admin::admin.captcha_error','admin::admin.required','admin::admin.login_successful','admin::admin.login_failed',
'admin::admin.user_setting','admin::admin.created_at','admin::admin.updated_at','admin::admin.deleted_at','admin::admin.actions',
'admin::admin.create','admin::admin.edit','admin::admin.show','admin::admin.delete','admin::admin.batch_delete',
'admin::admin.copy','admin::admin.confirm_delete','admin::admin.back','admin::admin.reset','admin::admin.search',
'admin::admin.list','admin::admin.add','admin::admin.save','admin::admin.detail','admin::admin.developer',
'admin::admin.code_generator','admin::admin.visual_editor','admin::admin.terminal','admin::admin.administrator','admin::admin.soft_delete',
'admin::admin.keyword','admin::admin.unknown_error','admin::admin.upload_file_error','admin::admin.parent','admin::admin.order',
'admin::admin.order_desc','admin::admin.order_asc','admin::admin.menus','admin::admin.successfully','admin::admin.failed',
'admin::admin.successfully_message','admin::admin.failed_message','admin::admin.action_success','admin::admin.action_failed','admin::admin.save_success',
'admin::admin.save_failed','admin::admin.yes','admin::admin.no','admin::admin.need_start_with_slash','admin::admin.cancel',
'admin::admin.please_login','admin::admin.unauthorized','admin::admin.user_disabled','admin::admin.preview','admin::admin.more',
'admin::admin.per_page_suffix','admin::admin.code_generators.remark1','admin::admin.code_generators.remark2','admin::admin.code_generators.remark3','admin::admin.code_generators.table_name',
'admin::admin.code_generators.new_table_name','admin::admin.code_generators.model_name','admin::admin.code_generators.controller_name','admin::admin.code_generators.service_name','admin::admin.code_generators.primary_key',
'admin::admin.code_generators.primary_key_description','admin::admin.code_generators.options','admin::admin.code_generators.create_database_migration','admin::admin.code_generators.create_table','admin::admin.code_generators.create_model',
'admin::admin.code_generators.create_controller','admin::admin.code_generators.create_service','admin::admin.code_generators.app_title','admin::admin.code_generators.new_app_title','admin::admin.code_generators.column_name',
'admin::admin.code_generators.type','admin::admin.code_generators.extra_params','admin::admin.code_generators.nullable','admin::admin.code_generators.index','admin::admin.code_generators.default_value',
'admin::admin.code_generators.comment','admin::admin.code_generators.exists_table','admin::admin.code_generators.generate_code','admin::admin.code_generators.expand_more_settings','admin::admin.code_generators.collapse_settings',
'admin::admin.code_generators.confirm_generate_code','admin::admin.code_generators.preview','admin::admin.code_generators.base_info','admin::admin.code_generators.column_info','admin::admin.code_generators.route_config',
'admin::admin.code_generators.page_config','admin::admin.code_generators.gen_route_menu','admin::admin.code_generators.route','admin::admin.code_generators.menu_name','admin::admin.code_generators.parent_menu',
'admin::admin.code_generators.menu_icon','admin::admin.code_generators.name_label_desc','admin::admin.code_generators.column_warning','admin::admin.code_generators.add_column','admin::admin.code_generators.scope',
'admin::admin.code_generators.list_component','admin::admin.code_generators.list_component_desc','admin::admin.code_generators.form_component','admin::admin.code_generators.form_component_desc','admin::admin.code_generators.detail_component',
'admin::admin.code_generators.detail_component_desc','admin::admin.code_generators.model_config','admin::admin.code_generators.file_column','admin::admin.code_generators.file_column_multi','admin::admin.code_generators.file_column_desc',
'admin::admin.code_generators.preview_code','admin::admin.code_generators.property','admin::admin.code_generators.property_name','admin::admin.code_generators.value','admin::admin.code_generators.dialog_form',
'admin::admin.code_generators.copy_record','admin::admin.code_generators.copy_record_description','admin::admin.code_generators.import_record','admin::admin.code_generators.import_record_placeholder','admin::admin.code_generators.import_record_desc',
'admin::admin.code_generators.load_config','admin::admin.code_generators.load_component_config','admin::admin.code_generators.fill','admin::admin.code_generators.save_current_config','admin::admin.code_generators.input_config_name',
'admin::admin.code_generators.same_name_tips','admin::admin.code_generators.save_path_dir','admin::admin.code_generators.save_path_select','admin::admin.code_generators.save_path_select_tips','admin::admin.code_generators.save_path_label_prefix',
'admin::admin.code_generators.clear_code','admin::admin.code_generators.select_clear_record','admin::admin.code_generators.select_generate_record','admin::admin.code_generators.duplicate_column','admin::admin.code_generators.common_field_add',
'admin::admin.code_generators.common_field_add_column','admin::admin.code_generators.config_name','admin::admin.code_generators.field_config','admin::admin.code_generators.field_name','admin::admin.code_generators.list_display',
'admin::admin.code_generators.duplicate_filter_input_name','admin::admin.code_generators.list_filter','admin::admin.code_generators.filter_type','admin::admin.code_generators.filter_mode','admin::admin.code_generators.filter_mode_fixed',
'admin::admin.code_generators.filter_mode_fixed_value','admin::admin.code_generators.filter_mode_input','admin::admin.code_generators.filter_input_name','admin::admin.code_generators.filter_input_label','admin::admin.code_generators.filter_component',
'admin::admin.code_generators.page','admin::admin.code_generators.dialog','admin::admin.code_generators.drawer','admin::admin.code_generators.dialog_size','admin::admin.code_generators.drawer_size',
'admin::admin.code_generators.clone_record','admin::admin.admin_users','admin::admin.admin_user.avatar','admin::admin.admin_user.name','admin::admin.admin_user.roles',
'admin::admin.admin_user.search_username','admin::admin.admin_user.password_confirmation','admin::admin.admin_user.old_password_required','admin::admin.admin_user.old_password_error','admin::admin.admin_user.username_already_exists',
'admin::admin.admin_user.cannot_delete','admin::admin.admin_roles','admin::admin.admin_role.name','admin::admin.admin_role.slug','admin::admin.admin_role.permissions',
'admin::admin.admin_role.slug_description','admin::admin.admin_role.name_already_exists','admin::admin.admin_role.slug_already_exists','admin::admin.admin_role.set_permissions','admin::admin.admin_role.cannot_delete',
'admin::admin.admin_role.used','admin::admin.admin_permissions','admin::admin.admin_permission.name','admin::admin.admin_permission.slug','admin::admin.admin_permission.http_method',
'admin::admin.admin_permission.http_method_description','admin::admin.admin_permission.http_path','admin::admin.admin_permission.auto_generate','admin::admin.admin_permission.auto_generate_confirm','admin::admin.admin_permission.parent_id_not_allow',
'admin::admin.admin_permission.name_already_exists','admin::admin.admin_permission.slug_already_exists','admin::admin.admin_menus','admin::admin.admin_menu.parent_id','admin::admin.admin_menu.order',
'admin::admin.admin_menu.title','admin::admin.admin_menu.icon','admin::admin.admin_menu.icon_description','admin::admin.admin_menu.url','admin::admin.admin_menu.iframe_description',
'admin::admin.admin_menu.visible','admin::admin.admin_menu.type','admin::admin.admin_menu.keep_alive','admin::admin.admin_menu.api','admin::admin.admin_menu.api_description',
'admin::admin.admin_menu.route','admin::admin.admin_menu.link','admin::admin.admin_menu.iframe','admin::admin.admin_menu.page','admin::admin.admin_menu.class_name',
'admin::admin.admin_menu.class_name_description','admin::admin.admin_menu.show','admin::admin.admin_menu.hide','admin::admin.admin_menu.is_home','admin::admin.admin_menu.is_home_description',
'admin::admin.admin_menu.is_full','admin::admin.admin_menu.is_full_description','admin::admin.admin_menu.parent_id_not_allow','admin::admin.admin_menu.component','admin::admin.admin_menu.component_desc',
'admin::admin.admin_menu.url_exists','admin::admin.extensions.name_invalid','admin::admin.extensions.exists','admin::admin.extensions.menu','admin::admin.extensions.page_title',
'admin::admin.extensions.create','admin::admin.extensions.install','admin::admin.extensions.create_extension','admin::admin.extensions.create_tips','admin::admin.extensions.local_install',
'admin::admin.extensions.more_extensions','admin::admin.extensions.setting','admin::admin.extensions.enable','admin::admin.extensions.enable_confirm','admin::admin.extensions.disable',
'admin::admin.extensions.disable_confirm','admin::admin.extensions.uninstall','admin::admin.extensions.uninstall_confirm','admin::admin.extensions.filter_placeholder','admin::admin.extensions.form.create_extension',
'admin::admin.extensions.form.name','admin::admin.extensions.form.namespace','admin::admin.extensions.form.create_description','admin::admin.extensions.card.author','admin::admin.extensions.card.version',
'admin::admin.extensions.card.homepage','admin::admin.extensions.card.status','admin::admin.extensions.status_map.enabled','admin::admin.extensions.status_map.disabled','admin::admin.extensions.validation.file',
'admin::admin.extensions.validation.invalid_package','admin::admin.export.title','admin::admin.export.all','admin::admin.export.page','admin::admin.export.selected_rows',
'admin::admin.export.page_no_data','admin::admin.export.selected_rows_no_data','admin::admin.export.please_install_laravel_excel','admin::admin.pages.menu','admin::admin.pages.title',
'admin::admin.pages.sign','admin::admin.pages.page','admin::admin.pages.schema_cannot_be_empty','admin::admin.pages.sign_exists','admin::admin.relationships.menu',
'admin::admin.relationships.model','admin::admin.relationships.title','admin::admin.relationships.remark','admin::admin.relationships.generate_model','admin::admin.relationships.generate',
'admin::admin.relationships.args','admin::admin.relationships.type','admin::admin.relationships.related_model','admin::admin.relationships.through_model','admin::admin.relationships.model_exists',
'admin::admin.relationships.rel_name_exists','admin::admin.apis.menu','admin::admin.apis.title','admin::admin.apis.path','admin::admin.apis.template',
'admin::admin.apis.enabled','admin::admin.apis.args','admin::admin.apis.path_exists','admin::admin.apis.template_format_error','admin::admin.apis.template_exists',
'admin::admin.apis.add_template','admin::admin.apis.add_template_tips','admin::admin.apis.paste_template','admin::admin.apis.overlay','admin::admin.api_templates.data_list',
'admin::admin.api_templates.data_create','admin::admin.api_templates.data_update','admin::admin.api_templates.data_delete','admin::admin.api_templates.data_detail','admin::menu.dashboard',
'admin::menu.admin_system','admin::menu.admin_users','admin::menu.admin_roles','admin::menu.admin_permission','admin::menu.admin_menu',
'admin::menu.admin_setting',);
