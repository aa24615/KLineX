...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','migrations-generator.migration_template_path',
...
'web','api',);
        registerArgumentsSet('routes', 'pay.notifyMnp','pay.notifyOa','pay.aliNotify','channel.official_account_reply.index','storage.local',);
