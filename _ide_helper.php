...
namespace Illuminate\Database\Query {
    ...
    class Builder {
         ...
         * 
         *
         * @see \App\Providers\QueryBuilderExtendProvider::boot()
         * @param mixed $searchWhere
         * @static 
         */
        public static function applySearchWhere($searchWhere)
        {
            return \Illuminate\Database\Query\Builder::applySearchWhere($searchWhere);
        }
         ...
         * @static 
         */
        public static function applySortOrder($sortOrder)
        {
            return \Illuminate\Database\Query\Builder::applySortOrder($sortOrder);
        }
